"""Build the Plaid MFA Attestation PDF from the markdown source.

Writes:
  - /mnt/documents/goldfin-mfa-attestation.pdf   (chat artifact)
  - public/downloads/goldfin-mfa-attestation.pdf (web download)
"""
...
SRC = Path("docs/plaid/mfa-attestation.md")
OUT_DOCS = Path("/mnt/documents/goldfin-mfa-attestation.pdf")
OUT_PUBLIC = Path("public/downloads/goldfin-mfa-attestation.pdf")
...
def header_footer(canvas, doc):
    ...
    canvas.drawString(0.75*inch, LETTER[1]-0.45*inch, "GoldFin Desk · MFA Attestation for Plaid Production Access")
    canvas.drawRightString(LETTER[0]-0.75*inch, LETTER[1]-0.45*inch, "v2026-06-26.1")
    canvas.drawCentredString(LETTER[0]/2, 0.45*inch, f"Page {doc.page}  ·  goldfindesk.com/mfa-attestation")
    canvas.restoreState()
...
def build(out: Path):
    doc = SimpleDocTemplate(str(out), pagesize=LETTER,
                            ...
                            title="GoldFin Desk — MFA Attestation for Plaid",
                            author="GoldFin Desk")
