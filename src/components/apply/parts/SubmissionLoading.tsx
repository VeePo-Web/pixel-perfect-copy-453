  ...
  return (
    <div className="rounded-2xl border border-ink/[0.08] bg-white p-6 shadow-[0_1px_2px_rgba(11,13,18,0.04)]">
      <div className="mb-4 flex items-center gap-3">
        ...
        <span className="font-general text-[10.5px] uppercase tracking-[0.28em] text-ink/45">Submitting</span>
      </div>
      <div key={i} className="text-[14.5px] text-ink/80 motion-safe:animate-section-in">
        {APPLY.step5.loading[i]}
      </div>
      <div className="mt-5 h-[2px] w-full overflow-hidden rounded-full bg-ink/[0.06]">
