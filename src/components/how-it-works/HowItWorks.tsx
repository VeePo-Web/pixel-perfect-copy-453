    ...
    >
      ...
      >
        <a
          ...
          className="relative block overflow-hidden rounded-full bg-gradient-to-b from-champagne-100 to-champagne-200 px-6 py-3.5 text-center text-[13px] font-medium tracking-wide text-ink shadow-[0_10px_40px_-10px_rgba(217,190,130,0.55)] transition-all duration-300 ease-cinema active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-champagne-200 focus-visible:ring-offset-2"
        >
