          ...
          <div className="grid gap-10 p-8 sm:p-10 lg:grid-cols-[1.25fr_1fr] lg:gap-14 lg:p-12">
            ...
            <div className="flex flex-col justify-center rounded-2xl border border-ink/[0.07] bg-ink/[0.02] p-7 sm:p-8">
              ...
              <button
                ...
                className="group relative mt-7 overflow-hidden rounded-full bg-gradient-to-b from-champagne-100 to-champagne-300 px-7 py-3.5 text-[13.5px] font-medium tracking-wide text-navy transition-all duration-400 ease-cinema hover:shadow-[0_14px_50px_-12px_rgba(217,190,130,0.6)]"
              >
              ...
              <p className="mt-4 border-t border-ink/[0.06] pt-4 text-[11.5px] leading-[1.6] text-ink/45">
                {o.trust}
              </p>
