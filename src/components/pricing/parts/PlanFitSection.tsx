    ...
    <section aria-labelledby="fit-title" className="border-b border-ink/[0.05] bg-charcoal-950">
      <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {planFit.map((col) => {
            const flagship = col.tone === "flagship";
            return (
              <div
                key={col.title}
              ...
              >
                ...
                <a
                  ...
                  className={`mt-7 inline-flex w-full items-center justify-center gap-2 rounded-full px-5 py-3 text-[13px] font-medium tracking-wide transition-all duration-300 ease-cinema active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ${
                    flagship
                      ? "bg-gradient-to-b from-champagne-100 to-champagne-300 text-navy hover:-translate-y-0.5 hover:shadow-[0_14px_50px_-12px_rgba(217,190,130,0.6)] active:translate-y-0 focus-visible:ring-champagne-300/70"
