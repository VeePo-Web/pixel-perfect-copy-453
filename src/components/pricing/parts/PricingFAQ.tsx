...
export default function PricingFAQ() {
  return (
    <section aria-labelledby="faq-title" className="border-b border-ink/[0.06] bg-white">
      <script
      ...
      <div className="mx-auto max-w-5xl px-6 py-20 md:py-28 lg:px-10">
        <div className="max-w-[58ch]">
          ...
          <h2 id="faq-title" className="mt-5 font-display font-medium text-ink [text-wrap:balance] text-[34px] leading-[1.08] tracking-[-0.02em] sm:text-[44px]">
            Questions owners ask before starting.
          </h2>
        </div>

        <div className="mt-12 divide-y divide-ink/[0.06] overflow-hidden rounded-2xl border border-ink/[0.08] bg-white shadow-[0_1px_2px_rgba(11,13,18,0.04)]">
          {faq.map((item, i) => (
        ...
        <p className="mt-8 font-general text-[10.5px] uppercase tracking-[0.2em] text-ink/40">
