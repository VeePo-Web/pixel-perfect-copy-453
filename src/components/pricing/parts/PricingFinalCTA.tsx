      ...
      <div className="relative mx-auto max-w-5xl px-6 py-28 text-center lg:px-10">
          ...
          {[0, 1, 2].map((i) => (
            <div
              ...
              className={`mx-[-12px] h-[110px] w-[120px] rounded-xl border bg-charcoal-900/70 backdrop-blur-sm motion-safe:animate-panel-rise ${
                i === 1
                  ...
                  : "z-10 border-ink/[0.08] opacity-80"
              }`}
              style={{
            ...
            >
              ...
              <div className="p-3">
                ...
                <div className="mt-2 h-1 w-1/2 rounded bg-ink/[0.08]" />
                <div className="mt-4 h-3 w-1/3 rounded bg-ink/15" />
                <div className="mt-3 space-y-1.5">
                  <div className="h-1 w-full rounded bg-ink/[0.06]" />
                  <div className="h-1 w-3/4 rounded bg-ink/[0.06]" />
                  <div className="h-1 w-2/3 rounded bg-ink/[0.06]" />
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
          ...
          <a
            ...
            className="rounded-full border border-ink/[0.12] px-6 py-3.5 text-[13.5px] text-bone/85 transition-all duration-300 hover:border-champagne-200/40 hover:text-bone"
          >
