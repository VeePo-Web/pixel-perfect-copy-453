...
export default function PricingHero() {
  return (
    <section className="relative isolate overflow-hidden border-b border-ink/[0.06] bg-white">
        ...
        <div className="grid items-start gap-14 lg:grid-cols-[1.05fr_1.1fr] lg:gap-16">
          <div className="motion-safe:animate-section-in">
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              ...
              <a
                href="/templates"
                className="rounded text-[12.5px] text-ink/55 underline-offset-4 transition-colors hover:text-ink hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-champagne-200 focus-visible:ring-offset-2 focus-visible:ring-offset-white"
              >
          ...
          >
            ...
            <div className="absolute left-1/2 top-1/2 h-[380px] w-[380px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(212,168,69,0.16),transparent_70%)] blur-2xl" />

            {/* quiet value-ladder cards — small, fully visible, tucked at the corners */}
            <div className="absolute left-0 top-[12%] hidden w-[150px] -rotate-6 rounded-2xl border border-ink/[0.08] bg-white p-4 opacity-[0.55] shadow-[0_16px_40px_-24px_rgba(11,13,18,0.25)] motion-safe:animate-panel-rise sm:block">
              <div className="font-general text-[9px] uppercase tracking-[0.26em] text-ink/40">Free</div>
              <div className="mt-1.5 whitespace-nowrap text-[12px] text-ink/70">Template Vault</div>
              <div className="mt-2 font-display text-[22px] font-medium leading-none tabular-nums text-ink/60">Free</div>
            </div>
            <div
            ...
            <div
              className="relative z-20 w-[80%] max-w-[348px] overflow-hidden rounded-[22px] border border-champagne-200/50 bg-white shadow-[0_30px_80px_-30px_rgba(11,13,18,0.28),0_20px_60px_-28px_rgba(184,137,58,0.35)] motion-safe:animate-panel-rise"
            ...
            >
              ...
              <div className="relative px-6 pb-6 pt-5">
                <div className="flex items-center justify-between">
                  <span className="inline-flex items-center gap-1.5 rounded-full border border-champagne-200/50 bg-champagne-50/50 px-2.5 py-1 font-general text-[9.5px] uppercase tracking-[0.22em] text-champagne-300">
                    <span className="h-1 w-1 rounded-full bg-champagne-300" />
                    Recommended
                  </span>
                  <span className="font-general text-[9.5px] uppercase tracking-[0.24em] text-ink/35">Continuity</span>
                </div>
                <div className="mt-4 text-[15px] text-ink">GoldFin Reports</div>
                <div className="mt-1 flex items-baseline gap-1.5">
                  <span className="font-display text-[54px] font-medium leading-none tracking-[-0.01em] tabular-nums text-ink">$150</span>
                ...
                <div className="mt-6 rounded-full bg-gradient-to-b from-champagne-100 to-champagne-200 py-2.5 text-center text-[12px] font-medium text-ink shadow-[inset_0_1px_0_rgba(255,255,255,0.45),0_8px_20px_-10px_rgba(184,137,58,0.45)]">
