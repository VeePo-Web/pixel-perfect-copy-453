...
export default function RecommendedPlanSpotlight() {
  return (
    <section aria-labelledby="spotlight-title" className="relative border-b border-ink/[0.06] bg-white">
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(60%_40%_at_50%_0%,rgba(201,163,90,0.06),transparent_65%)]" />
      </div>
      <div className="relative mx-auto max-w-7xl px-6 py-20 md:py-28 lg:px-10">
        <div className="mb-12 max-w-[58ch]">
          ...
          <h2 id="spotlight-title" className="mt-5 font-display font-medium text-ink [text-wrap:balance] text-[34px] leading-[1.08] tracking-[-0.02em] sm:text-[46px]">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-ink/[0.08] bg-white shadow-[0_24px_70px_-32px_rgba(11,13,18,0.14)]">
          ...
          <div className="grid gap-10 p-8 sm:p-10 lg:grid-cols-[1fr_1.3fr] lg:gap-14 lg:p-14">
            <div>
              ...
              <h3 className="mt-5 font-display text-[28px] font-medium leading-[1.1] tracking-[-0.01em] text-ink">
                The GoldFin Desk
              </h3>
              ...
              <p className="mt-4 font-general text-[10.5px] uppercase tracking-[0.22em] text-ink/45">
                Most owners start at $150 · Advisory is application-only
              </p>
            </div>

            <div>
              <div className="font-general text-[10.5px] uppercase tracking-[0.22em] text-ink/45">
                Your monthly rhythm
              </div>
              <ol className="mt-5 space-y-3">
                {monthlyRhythm.map((r, i) => (
                  <li
                    key={r.week}
                    className="grid grid-cols-[80px_1fr] items-center gap-4 rounded-xl border border-ink/[0.08] bg-ink/[0.02] px-5 py-4"
                    style={{ animationDelay: `${i * 80}ms` }}
                  >
                    <span className="font-general text-[10.5px] uppercase tracking-[0.22em] tabular-nums text-champagne-300/80">
                      {r.week}
                    </span>
              ...
              <p className="mt-6 font-general text-[10.5px] uppercase tracking-[0.2em] text-ink/40">
