      ...
      <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2">
          {whyCards.map((c) => (
            <div
              key={c.title}
              className="group relative overflow-hidden rounded-2xl border border-ink/[0.07] bg-charcoal-900/55 p-7 transition-all duration-300 ease-cinema hover:-translate-y-0.5 hover:border-champagne-200/25 hover:shadow-[0_24px_60px_-30px_rgba(217,190,130,0.25)]"
            >
