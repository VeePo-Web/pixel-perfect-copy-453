  ...
  return (
    <div className="relative rounded-2xl border border-ink/[0.08] bg-charcoal-900/50 p-5 backdrop-blur-sm transition-colors duration-400 ease-cinema focus-within:border-champagne-200/30">
      ...
      <textarea
        ...
        className="w-full resize-none bg-transparent text-[15px] leading-[1.6] text-bone placeholder:text-bone/35 focus:outline-none"
      />
      ...
      <div className="mt-4 flex flex-wrap items-center gap-3">
        ...
        <a
          href="#/apply"
          className="ml-auto text-[12.5px] text-bone/55 underline-offset-4 transition-colors hover:text-bone hover:underline"
        >
