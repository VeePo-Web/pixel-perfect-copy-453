    ...
    <ModuleShell id="cash-movement" eyebrow="Cash Movement" title="What actually changed in cash this period.">
      <div className="grid gap-6 lg:grid-cols-[1fr_1.3fr]">
        <div className="space-y-4">
          ...
          <p className="text-[11.5px] uppercase tracking-[0.2em] text-ink/40">
            Your bank account shows what is left. The briefing explains what changed and why it matters.
          </p>
        </div>
        <div className="rounded-xl border border-ink/[0.07] bg-ink/[0.02] p-5">
          <div className="text-[10.5px] uppercase tracking-[0.22em] text-ink/55">Trailing trend</div>
          ...
          <div className="mt-4 rounded-lg border border-ink/[0.06] bg-charcoal-900/60 p-4">
            <div className="text-[10.5px] uppercase tracking-[0.22em] text-ink/55">What this means</div>
            <p className="mt-2 text-[14.5px] leading-[1.7] text-ink/85">{business.insights.cash}</p>
          </div>
        </div>
      </div>
    </ModuleShell>
