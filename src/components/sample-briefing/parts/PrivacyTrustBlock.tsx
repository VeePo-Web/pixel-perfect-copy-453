    ...
    <section className="border-b border-ink/[0.05] bg-charcoal-950">
      <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
        ...
        <div className="mt-12 flex flex-wrap items-center gap-4">
          ...
          >
            <span aria-hidden className="relative z-10">Auto-fill my reports â€” $99/mo</span>
        ...
        <p className="mt-3 text-[11.5px] uppercase tracking-[0.22em] text-ink/40">No contracts Â· Cancel anytime</p>
      </div>
    </section>
  );
}
