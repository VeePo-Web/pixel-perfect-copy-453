    ...
    >
      <ol className="space-y-3">
        {business.questions.map((q, i) => (
          <li
            key={q}
            className="flex items-start gap-4 rounded-xl border border-white/[0.06] bg-white/[0.015] px-5 py-4 transition-all duration-300 ease-cinema hover:border-champagne-200/25 hover:bg-white/[0.03]"
          >
