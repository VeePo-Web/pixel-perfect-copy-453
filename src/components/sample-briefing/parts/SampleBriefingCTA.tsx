      ...
      <div className="relative mx-auto max-w-5xl px-6 py-28 text-center lg:px-10">
        ...
        <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
          ...
          <button
            type="button"
            onClick={onAnother}
            className="rounded-full border border-ink/[0.12] px-6 py-3.5 text-[13.5px] text-bone/85 transition-all duration-300 ease-cinema hover:border-champagne-200/40 hover:text-bone"
          >
