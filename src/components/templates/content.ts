...
export const comparison = {
  free: {
    ...
    time: "~3 hrs / month",
    positioning: "Use the Vault manually",
    items: [
      "Download every template",
      "Drop in your own numbers",
      "Update it yourself each month",
      "Read and interpret it yourself",
  ...
  desk: {
    ...
    items: [
      "Every template filled from your numbers",
    ...
    bestFor: "Owners who want monthly clarity without doing the spreadsheet work.",
  },
};
