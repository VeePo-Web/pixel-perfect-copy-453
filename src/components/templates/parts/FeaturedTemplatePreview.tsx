...
const featured = templates.find((t) => t.id === "13-week-cash-map") ?? templates[0];

const notes = [
  { tag: "What changed?", body: "Software spend climbed and recurring costs are taking more of each deposit." },
  { tag: "What looks risky?", body: "Current cash is useful, but the reserve floor is still above the projected balance." },
  { tag: "What decision does this affect?", body: "Owner pay and discretionary spend should be reviewed before adding more fixed commitments." },
];
      ...
      <div ref={ref} className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
        <div className="max-w-[60ch]">
          ...
          <p className="mt-4 max-w-[58ch] text-[14.5px] leading-relaxed text-ink/65">
            ...
            bank-statement activity into a decision. This is exactly what GoldFin Reports fills
            in and sends every month.
          </p>
        </div>

        <div className="mt-10 grid items-start gap-8 lg:grid-cols-[1.1fr_1fr]">
          <SpreadsheetPreview rows={featured.previewRows} title={featured.shortName} />
            ...
            <p className="mt-1 text-[13px] leading-[1.6] text-ink/60">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  track("autofill_clicked_from_templates", { source: "featured" });
                }}
