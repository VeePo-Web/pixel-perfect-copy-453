  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={
          isPanel
            ? "relative ml-auto flex h-full w-full max-w-xl flex-col overflow-y-auto border-l border-ink/[0.08] bg-charcoal-950 shadow-[0_-20px_80px_-20px_rgba(0,0,0,0.6)]"
